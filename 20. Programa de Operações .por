//20. Programa de Operações com um Número: O programa solicitará ao usuário um
//número inteiro positivo e executará as seguintes operações: Verificar se o número é
//primo, calcular a soma dos números naturais até o número, exibir os primeiros N
//termos da sequência de Fibonacci, onde N é o número fornecido pelo usuário,
//inverter a ordem dos dígitos do número e calcular o fatorial do número.
programa {
    funcao inicio() {
